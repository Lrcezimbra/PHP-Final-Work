                ...
                <div id="content">
                  ...
                  <!-- Box -->
                    <div class="box">
                        ...
                        <!-- End Box Head -->
						<?php
						echo '<form action="../controle/eventocontrole.php?op=editar&idEvento='.$_GET['idEvento'].'" method="post">
                           	  <!-- Form -->
                              <div class="form">';
								...
								$evDAO = new EventoDAO();
								$dados = array();
								$dados = $evDAO->selecionarEvento($_GET['idEvento']);
								
								foreach($dados as $d){
									echo 
									'<label>Nome: </label>
									<input type="text" name="txtNome" placeholder="Nome" class="field size1" value="'.$d->nome.'"/>
									<br />
									<label>Descri&ccedil;&atilde;: </label>
									<input type="text" name="txtDescricao" placeholder="Descri&ccedil;&atilde;o" class="field size1" value="'.$d->descricao.'"/>
									<br />
									<label>Local: </label>
									<input type="teste" name="txtLocal" placeholder="Local" class="field size1" value="'.$d->local.'"/>
									<br />
									<label>Data: </label>
									...
									<input type="text" name="txtHorario" placeholder="Hor&aacute;" class="field size1" value="'.$d->horario.'"/>
									<br />
